...
namespace lm {
template <bool b> class GpioState;
}
...
public:
        ...
        //        Gpio (/*GPIO_TypeDef *port, uint32_t pin, uint32_t mode = GPIO_MODE_OUTPUT_PP, uint32_t pull = GPIO_NOPULL,
        ...
        template <bool b> friend class lm::GpioState;
