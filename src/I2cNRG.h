...
public:
        ...
        void read (uint8_t devAddr, uint8_t *data, size_t length, uint16_t timeout = DEFAULT_TIMEOUT);
        void write (uint8_t devAddr, uint8_t *data, size_t length, uint16_t timeout = DEFAULT_TIMEOUT);
